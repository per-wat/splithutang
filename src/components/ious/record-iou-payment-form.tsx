...
export function RecordIouPaymentForm({
  iouId,
  debtorName,
  creditorName,
  remaining,
  ...
  async function handleSave() {
    ...
    const { error } = await supabase.rpc("record_iou_payment", {
      p_iou_id: iouId,
    ...
    if (error) {
      console.error("Unable to record IOU payment:", error);
